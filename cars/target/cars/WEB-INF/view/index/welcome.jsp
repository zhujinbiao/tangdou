                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <blockquote class="layui-elem-quote">欢迎管理员：${loginUser.power}
                                <span class="x-red">${loginUser.realname}</span>！当前时间:<span id="time"></span>
                            </blockquote>
                        </div>
                    </div>
                </div>
...
datetime()
    function datetime() {
        ...
        var now =  year + "年" + mouth + "月" + day + "日" + " " + hour + ":" + minute + ":" + second ;
